...
export function SubmissionA() {
    const url = 'http://lb-project-463274464.us-east-1.elb.amazonaws.com:8001/users';
    const url2 = 'http://lb-project-463274464.us-east-1.elb.amazonaws.com:8001/submissions';
    ...
    const getUsers = async () => {
        try {
            ...
            console.log("Users response:", response.data); // Agregar log
    ...
    const getSubmissions = async () => {
        try {
            ...
            console.log("Submissions response:", response.data); // Agregar log
    ...
    const handleSubmit = async () => {
        console.log("editingId:", editingId); // Agregar log
        if (isEditing) {
            try {
