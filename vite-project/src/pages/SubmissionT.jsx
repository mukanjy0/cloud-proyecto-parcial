...
export function SubmissionT() {
    const url = 'http://lb-project-463274464.us-east-1.elb.amazonaws.com:8002/users';
    const url2 = 'http://lb-project-463274464.us-east-1.elb.amazonaws.com:8002/submissions';
